...
const file_pkg_plugins_grpc_driver_proto_driver_proto_rawDesc = "" +
	...
	"\tavailable\x18\x01 \x01(\bR\tavailable2\x86\x06\n" +
	"\rDriverService\x12L\n" +
	...
	"\x0fGetMemoryPlugin\x12\x18.driver.GetPluginRequest\x1a\x19.driver.GetPluginResponse\x12G\n" +
...
var file_pkg_plugins_grpc_driver_proto_driver_proto_depIdxs = []int32{
	...
	13, // 21: driver.DriverService.GetMemoryPlugin:output_type -> driver.GetPluginResponse
